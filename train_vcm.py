...
from datasets.make_dataloader_clipreid_vvi import make_dataloader_lmdb, make_dataloader_imgs
...
if __name__ == '__main__':
    ...
    #--> 数据加载
    #############################################
    loader_list, num_query1, num_query2, num_classes, camera_num = make_dataloader_imgs(cfg)
