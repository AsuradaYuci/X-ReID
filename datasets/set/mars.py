...
class Mars(object):
	...
	def __init__(self, root='../data/Mars/', min_seq_len=0):
		root1 = '/18640539002/dataset_cc/Mars/'
		root2 = '/media/ycy/18b21f78-77a1-403a-959e-d65e937da92b/data/Mars'
		root3 = '/13994058190/YCY/dataset/Mars'
		if osp.exists(root1):
			self.root = root1
	...
	def _process_data(self, names, meta_data, home_dir=None, relabel=False, min_seq_len=0, json_path=''):
		...
		# 	return split['tracklets'], split['num_tracklets'], split['num_pids'], split['num_imgs_per_tracklet'], split[
		# 		'num_cams'], split['num_tracks']
